...
class _SignUpViewState extends State<SignUpView> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                "Điền thông tin cụ thể để đăng ký",
                style: TextStyle(
  ...
  void serviceCallSignUp(Map<String, dynamic> parameter) {
    ...
    ServiceCall.post(SVKey.svSignUp, parameter,
      ...
      if (responseObj[KKey.status] == "1") {
        ...
        // Lưu tên vào SharedPreferences sau khi đăng ký thành công
        SharedPreferences prefs = await SharedPreferences.getInstance();
        await prefs.setString("user_name", parameter["name"]);
