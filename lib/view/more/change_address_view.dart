  ...
  _customMarker(String symbol, Color color) {
    return SizedBox(
      ...
      child: Column(
        children: [
          Image.network(
            'https://res.cloudinary.com/dfya8dc81/image/upload/v1738811565/map_pin_kke7i6.png',
            width: 35,
            fit: BoxFit.contain,
          )
        ],
      ...
      bottomNavigationBar: BottomAppBar(
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(children: [
              Image.network(
                  'https://res.cloudinary.com/dfya8dc81/image/upload/v1738811556/fav_icon_mjai7w.png',
                  width: 35,
                  height: 35),
              const SizedBox(
                width: 8,
